<template>
  <div class="container">
    <div class="bg-nicegray h-20 px-16">
      <div class="flex pt-4">
        <transition-group
          class="categories mt-2 container mx-auto overflow-x-auto flex flex-row items-center"
          name="chips"
          tag="div"
        >
          <button
        ...
        <div
          class="absolute mx-10 left-0 w-12 h-12 bg-nicegray filter blur-sm"
        ></div>
        <div
          class="absolute mx-10 right-0 w-12 h-12 bg-nicegray filter blur-sm"
        ></div>
      </div>
    </div>
  </div>
